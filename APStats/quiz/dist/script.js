...
var question4 ={
                  question: "What number logically follows this series? 1, 4, 9, 16",
                  answers: ['25', '12','24','0'],
                  correct: 0
                };
...
function showQuestions (){
  ...
  if (currentIndex != 0) {
    ...
    if(quizPage == 3){
      start();
      button.innerHTML = 'Click here to reload';;
      reloaded = 1;
    }
...
function checkAnswer (){
  ...
  quizPage++;
  currentIndex++;
  currentQuestion = questions[currentIndex];    showQuestions();
    reloaded = 2;
  }

  // check that an answer has been selected
  if (selectedItem == undefined && reloaded != 2){
...
function showResults () {
  document.write("Thanks for taking this quiz! Quiz Code: " + time);
}
